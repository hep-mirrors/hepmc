...
{\Large User Manual Version 2.05} \\
June 2, 2009
...
Note that the E, U, C, H, and F lines contain event header information.
...
\subsection{HepMC::ParticleData (deprecated since HepMC 2.02.00)}
...
\subsection{HepMC::ParticleDataTable (deprecated since HepMC 2.02.00)}
\begin{myitemize}{Important Public Methods}
