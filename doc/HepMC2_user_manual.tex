...
{\Large User Manual Version 2.01} \\
February 5, 2008
...
Use IO\_ExtendedAscii to read and write the generated mass, as well 
as the heavy ion class and a PDF information class.
...
\subsubsection{HepMC::ParticleData}
...
\begin{myitemize}{Notes and Conventions}
  ...
  \item The ParticleData and ParticleDataTable classes have become outmoded.  
     Instead of using these classes, we recommend using packages developed 
     for this purpose, such as HepPDT~\cite{heppdt}.
\end{myitemize}

The ParticleData and ParticleDataTable classes have become outmoded.  
Instead of using these classes, we recommend using packages developed 
for this purpose, such as HepPDT~\cite{heppdt}.
...
\subsubsection{HepMC::ParticleDataTable}
