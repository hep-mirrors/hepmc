...
public:
  ...
  // recognize the heavily deprecated IO_PDG_ParticleDataTable
  std::string IO_ParticleDataTable_Key() const { return m_io_pdt_start; }
  std::string IO_ParticleDataTable_End() const { return m_io_pdt_end; }
  ...
  void write_IO_ParticleDataTable_Key( std::ostream& );
  void write_IO_ParticleDataTable_End( std::ostream& );
...
protected:
  // methods used by the read_io* methods
    HeavyIon* read_heavy_ion(std::istream* is);
    PdfInfo* read_pdf_info(std::istream* is);
    GenParticle* read_particle(std::istream* is,
                  TempParticleMap& particle_to_end_vertex );
    GenVertex* read_vertex(std::istream* is, 
                  TempParticleMap& particle_to_end_vertex );
...
inline void CommonIO::write_IO_ParticleDataTable_Key( std::ostream& os )
{ os << m_io_pdt_start << "\n"; }

inline void CommonIO::write_IO_ParticleDataTable_End( std::ostream& os )
{ os << m_io_pdt_end << "\n"; }
