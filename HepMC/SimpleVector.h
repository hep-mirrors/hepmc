...
// Also, both FourVector and ThreeVector have a templated constructor that will take 
// another vector (HepLorentzVector, GenVector, ...)
...
public:
  ...
  inline double px() const { return m_x; }
  inline double py() const { return m_y; }
  inline double pz() const { return m_z; }
  inline double e()  const { return m_t; }
  ...
  inline void setT(double t) { m_t=t; }

  inline void setPx(double x) { m_x=x; }
  inline void setPy(double y) { m_y=y; }
  inline void setPz(double z) { m_z=z; }
  inline void setE(double t)  { m_t=t; }
